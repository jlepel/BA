...
\HAWThesisProperties{Author={Jan Lepel}
                    ,Title={Automatisierte Erstellung und Provisionierung von ad hoc Linuxumgebungen -\\  Prototyp einer zentralisierten Weboberfläche zur vereinfachten Umsetzung individuell erstellter Systeme}
                    ,EnglishTitle={TODO}
